...
final class CoreDataUtility {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: "BoxOffice")
    ...
    */
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        let modelURL = Bundle(for: CoreDataUtility.self).url(forResource: "BoxOffice", withExtension: "momd")!
        return NSManagedObjectModel(contentsOf: modelURL)!
    }()
    
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        let coordinator = NSPersistentStoreCoordinator(managedObjectModel: managedObjectModel)
        let url = applicationDocumentsDirectory.appendingPathComponent("BoxOffice.sqlite")
